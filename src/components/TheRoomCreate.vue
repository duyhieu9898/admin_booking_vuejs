          ...
          <div class="card-body">
              ...
              <div class="card-box txt-full-width is-dirty is-upgraded">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    ></room-convenients-component>
                    <input type="hidden"  v-validate="'required'" name="convenient_room" v-model="list_convenients">
            ...
            <div class="col-lg-12 p-t-20">
              <room-photo-component @arr-images-id="getArrImagesId"></room-photo-component>
               <input type="hidden"  v-validate="'required'" name="photo_room" v-model="room.list_images_id">
              <span v-show="errors.has('photo_room')" class="errors">{{ errors.first('photo_room') }}</span>
            </div>
